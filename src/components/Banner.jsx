    ...
    <div className="bg-white py-8 px-6 border-b border-gray-200">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* In-Progress Card */}
          <div
            className="relative rounded-lg p-10 text-white overflow-hidden shadow-lg"
            style={{
              background: "linear-gradient(135deg, #8B5CF6 0%, #7C3AED 100%)",
            }}
          >
            <div className="relative z-20">
              <h3 className="text-xl font-medium mb-3 opacity-90">
                In-Progress
              </h3>
              <p className="text-6xl font-bold">{inProgressCount}</p>
            </div>
            {/* Decorative Pattern */}
            <div className="absolute top-4 right-4 w-40 h-40 opacity-20 z-10">
              <img
                src="/vector1.svg"
                alt="decoration"
          ...
          >
            <div className="relative z-20">
              <h3 className="text-xl font-medium mb-3 opacity-90">Resolved</h3>
