    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-4">Download Our Apps</h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {browserExtensions.map((ext, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-lg border border-gray-200 p-6 text-center hover:border-purple-300 transition"
              >
                <div className="text-6xl mb-3">{ext.icon}</div>
                ...
                <button className="w-full bg-gray-900 hover:bg-gray-800 text-white py-2 rounded-md text-sm font-medium transition">
                  Add to {ext.browser}
                </button>
              </div>
            ))}
      ...
      {/* Web App Section */}
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl border border-purple-200 p-8 text-center">
