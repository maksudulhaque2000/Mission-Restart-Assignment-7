              ...
              <div className="grid grid-cols-2 gap-3">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href={social.link}
                    className="flex items-center gap-2 px-4 py-3 bg-gray-50 hover:bg-purple-50 rounded-md transition border border-gray-200 hover:border-purple-300"
                  >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="bg-gray-200 rounded-lg h-48 flex items-center justify-center text-gray-500">
                <div className="text-center">
                  ...
                  <p className="text-xs">123 Support Street, NY 10001</p>
                </div>
              </div>
            </div>
          </div>
